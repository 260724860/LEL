...
namespace Common
{
    ...
    public abstract partial class DbHelperMySQL
    {
        ...
        /// </summary>
        /// <param name="SQLStringList">多条SQL语句</param>		
        public static int ExecuteSqlTran(List<String> SQLStringList, params MySqlParameter[] cmdParms)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                conn.Open();
        ...
        /// </summary>
        /// <param name="SQLStringList">SQL语句的哈希表（key为sql语句，value是该语句的MySqlParameter[]）</param>
        public static long GetInsertId(string SQLString, params MySqlParameter[] cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                using (MySqlCommand cmd = new MySqlCommand())
        ...
        /// <summary>
        /// 执行多条SQL语句，实现数据库事务。 add by xiecy 2019/3/6 10：37
        /// modify xiecy 2019/03/26 增加sql修改条数判断
        /// </summary>
